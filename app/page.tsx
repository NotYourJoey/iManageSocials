  ...
  return (
    <div className="flex flex-col">
      ...
      <section className="relative overflow-hidden min-h-[85vh] md:min-h-screen">
        ...
        <div className="container relative z-10 grid gap-8 pt-12 pb-16 md:gap-12 md:pt-20 md:pb-32 md:grid-cols-[1.1fr,0.9fr] md:items-end">
          <motion.div
          ...
          <motion.div
            ...
            className="hidden flex-col space-y-5 rounded-3xl bg-white/10 p-6 text-white backdrop-blur-2xl md:flex md:p-8"
          >
